...
def make_db ():
    ...
    parser.prog = "Fast5Tools make_db"
...
def bam_to_db ():
    ...
    parser.prog = "Fast5Tools bam_to_db"
    ...
    parser.add_argument("--analysis_name", required=True, help="Name for the aligment analysis. Will through an error if a same name is already in the db")
...
def eventalign_to_db ():
    ...
    parser.prog = "Fast5Tools eventalign_to_db"

    # Define arguments
    parser.add_argument("subprogram")
    parser.add_argument("-d", "--db_fn", required=True, help="Path to the output database file")
    parser.add_argument("-e", "--eventalign_fn", required=True, help="Path to a tsv file output generated by nanopolish eventalign")
    parser.add_argument("--analysis_name", required=True, help="Name of the eventalign analysis in the fast5 file database. Will through an error if a same name is already in the db")
    parser.add_argument("--verbose", default=False, action='store_true', help="If given will be more chatty (default = False)")
